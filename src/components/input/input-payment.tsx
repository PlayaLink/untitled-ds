...
// Create icon components for payment cards
const VisaIcon = createIcon('visa')
const MastercardIcon = createIcon('mastercard')
const AmexIcon = createIcon('amex')
const DiscoverIcon = createIcon('discover')

type CardIconComponent = ComponentType<HTMLAttributes<HTMLOrSVGElement>>
...
const cardTypes: Array<{
    ...
    },
    {
        ...
        card: "unknown",
        icon: MastercardIcon, // Default to Mastercard icon
    },
];
