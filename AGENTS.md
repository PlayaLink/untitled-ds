<!-- BEGIN: AI RULES SYNC (generated) -->
## AI Rules (Synced)

_Generated by `/Users/jengland/claude/.ai-rules/sync-ai-rules.sh` on 2026-02-17._
_Edit source rules in `.ai-rules/`; do not edit this block directly._

### Global Rules (Always Apply)

#### `commit-messages`
_Source: `.ai-rules/global/commit-messages.md`_
...
_Source: `.ai-rules/global/component-similarity-check.md`_
...
_Source: `.ai-rules/global/datatable-conventions.md`_
...
#### `mcp-server`
_Source: `.ai-rules/global/mcp-server.md`_
...
#### `meta`
_Source: `.ai-rules/global/meta.md`_


## AI Rules Maintenance

When making changes that affect workflows, conventions, or processes documented in `ai-rules`, update the corresponding file to reflect the new reality.


#### `semantic-tagging`
_Source: `.ai-rules/global/semantic-tagging.md`_
...
_Source: `.ai-rules/global/untitled-ui-components.md`_
...
#### `project-overview`
_Source: `untitled-ds/.ai-rules/global/project-overview.md`_
...
#### `storybook-stories`
_Source: `untitled-ds/.ai-rules/global/storybook-stories.md`_
...
_Source: `untitled-ds/.ai-rules/conditional/custom-component-implementation.md`_
...
#### `design-tokens`
_Source: `untitled-ds/.ai-rules/conditional/design-tokens.md`_
...
#### `npm-publishing`
_Source: `untitled-ds/.ai-rules/conditional/npm-publishing.md`_
...
_Source: `untitled-ds/.ai-rules/conditional/untitled-ui-component.md`_
