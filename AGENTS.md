...
Claude Code auto-loads these directories — other AI tools will not see them.

- **`.claude/rules/*.md`** — Behavioral guidelines: conventions, patterns, workflows
- **`.claude/skills/*/SKILL.md`** — Reusable domain knowledge loaded on demand
- **`.claude/commands/*.md`** — On-demand workflows (invoked via `/command-name`)
