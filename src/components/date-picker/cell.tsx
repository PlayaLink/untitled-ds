        ...
        return (
          <div
            className={cx(
              ...
              // Disabled state.
              isDisabled ? 'text-disabled' : 'text-secondary hover:text-secondary-hover',
              // Focus ring, visible while the cell has keyboard focus.
              isFocusVisible ? 'outline-2 outline-offset-2 outline-focus-ring' : '',
              // Hover state for cells in the middle of the range.
              isSelected && !isDisabled && isRangeCalendar ? 'font-medium' : '',
              markedAsSelected && 'bg-brand-solid font-medium text-white hover:bg-brand-solid-hover hover:text-white',
