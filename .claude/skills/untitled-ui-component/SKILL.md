...
See `.claude/rules/design-tokens.md` for the full primitive→semantic mapping. Short version:
...
See `.claude/rules/storybook-stories.md` (always-on) for the full story spec. Every component must have exactly 3 stories: `Overview`, `Props`, `SourceCodeAndDesign`.
