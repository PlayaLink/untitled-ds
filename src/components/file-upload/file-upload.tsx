 ...
 * @docs https://www.untitledui.com/components/file-upload
 */
...
import { Icon, createIcon } from '@/components/icon'
...
const TrashIcon = createIcon('trash', 'md')
      ...
      <div className="flex min-w-0 flex-1 flex-col items-start">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                {isComplete && <Icon name="check-circle" size="md" className="text-fg-success-primary" />}
                {isComplete && <p className="text-sm font-medium text-success-primary">Complete</p>}

                {!isComplete && !failed && <Icon name="upload-cloud" size="md" className="text-fg-quaternary" />}
                {!isComplete && !failed && <p className="text-sm font-medium text-quaternary">Uploading...</p>}

                {failed && <Icon name="x-circle" size="md" className="text-fg-error-primary" />}
        ...
        {!failed && (
          <div className="mt-1 w-full">
            <ProgressBar labelPosition="right" max={100} value={progress} />
          </div>
        )}

        {failed && (
          <Button color="tertiary-destructive" size="sm" onPress={onRetry} className="mt-1.5">
            Try again
          </Button>
        )}
      </div>
            ...
            <div className="mt-0.5 flex items-center gap-2">
              ...
              {!failed && (
                <>
                  ...
                  <div className="flex items-center gap-1">
                    {isComplete && <Icon name="check-circle" size="md" className="text-fg-success-primary" />}
                    {!isComplete && <Icon name="upload-cloud" size="md" className="text-fg-quaternary" />}
