/**
 * Input component
 * @docs https://www.untitledui.com/react/components/input
 * @figma https://www.figma.com/design/fDxXGrTItVnXVTWhtx7yuQ/%E2%9D%96-BASE-COMPONENTS?node-id=19483-17067&t=0I08LiL2CtY11bEH-1
 */
        ...
        <AriaGroup
            ...
            {isInvalid && (
                <IconComponent
                    ...
                    size="sm"
                    className={cx(
                        "pointer-events-none absolute text-fg-error-secondary",
