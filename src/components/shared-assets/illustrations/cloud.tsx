...
export const sm = ({
    ...
    svgClassName,
    childrenClassName,
    children = <Icon name="search" className="size-6" />,
    ...otherProps
            ...
            <svg viewBox="0 0 152 120" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                ...
                <g filter="url(#filter-01-sm)">
                    ...
                    <path
                        ...
                        className="stroke-border-secondary-alt"
                    />
...
export const md = ({
    ...
    svgClassName,
    childrenClassName,
    children = <Icon name="search" className="size-7" />,
    ...otherProps
}: Omit<IllustrationProps, "size">) => {
    return (
            ...
            <svg viewBox="0 0 220 160" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                ...
                <g filter="url(#filter-01-lg)">
                    ...
                    <path
                        ...
                        className="fill-border-secondary-alt"
                        mask="url(#path-01-lg)"
                    />
