...
const MobilePresetButton = ({ value, children }: { value: { start: DateValue; end: DateValue }; children: React.ReactNode }) => {
  const context = useContext(RangeCalendarStateContext)
      ...
      >
        <div className="flex flex-col gap-3 px-6 py-5">
          <header className="relative flex items-center justify-between md:justify-start">
            ...
            <Button slot="next" iconLeading={ChevronRightIcon} size="sm" color="tertiary" className="size-8 md:hidden" />
          </header>
        ...
        {isDesktop && (
          <div className="flex flex-col gap-3 border-l border-secondary px-6 py-5">
            <header className="relative flex items-center justify-end">
              ...
              <Button slot="next" iconLeading={ChevronRightIcon} size="sm" color="tertiary" className="size-8" />
            </header>
