...
export const CloudIllustration = ({ size = "lg", ...otherProps }: IllustrationProps) => {
    ...
    return (<Pattern {...otherProps} data-untitled-ds='CloudIllustration' />);
};
...
export const sm = ({
    ...
    svgClassName,
    childrenClassName,
    children = <Icon name="search" size="lg" />,
    ...otherProps
    ...
    return (
        <div {...otherProps} className={cx("relative h-30 w-38", className)}>
            <svg viewBox="0 0 152 120" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="76" cy="52" r="52" className="fill-[var(--color-utility-gray-utility-gray-100)]" />

                <circle cx="21" cy="19" r="5" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="18" cy="109" r="7" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="145" cy="35" r="7" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="134" cy="8" r="4" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                ...
                <g filter="url(#filter-01-sm)">
                    <path
                        ...
                        className="fill-[var(--color-utility-gray-utility-gray-50)]"
                    />
                    <path
                        ...
                        className="stroke-[var(--color-utility-gray-utility-gray-200)]"
                    />
                ...
                <defs>
                    ...
                    <linearGradient id="cloud-gradient-01-sm" x1="26.9429" y1="37.4855" x2="72.2" y2="79.9998" gradientUnits="userSpaceOnUse">
                        <stop stopColor="currentColor" className="text-[var(--color-utility-gray-utility-gray-200)]" />
                        <stop offset="0.350715" stopColor="currentColor" className="text-[var(--color-utility-gray-utility-gray-50)]" />
                    </linearGradient>
...
export const md = ({
    ...
    svgClassName,
    childrenClassName,
    children = <Icon name="search" size="xl" />,
    ...otherProps
}: Omit<IllustrationProps, "size">) => {
    return (
        <div {...otherProps} className={cx("relative h-32 w-43", className)}>
            <svg viewBox="0 0 182 137" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="91" cy="64" r="64" className="fill-[var(--color-utility-gray-utility-gray-100)]" />

                <circle cx="25" cy="20" r="6" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="22" cy="112" r="8" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="165" cy="36" r="8" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="154" cy="9" r="5" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
    ...
    return (
        <div {...otherProps} className={cx("relative h-40 w-55", className)}>
            <svg viewBox="0 0 220 160" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="110" cy="80" r="80" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="26" cy="20" r="8" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="198" cy="126" r="6" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="25" cy="138" r="10" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="210" cy="46" r="10" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <circle cx="191" cy="11" r="7" className="fill-[var(--color-utility-gray-utility-gray-100)]" />
                <g filter="url(#filter-01-lg)">
                    ...
                    <path
                        ...
                        className="fill-[var(--color-utility-gray-utility-gray-200)]"
                        mask="url(#path-01-lg)"
                    />
